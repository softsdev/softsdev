...
class class_user_profile_functions{
	...
	public function profile_navs(){
		...
		$navs['following'] = array(
							'title'=>__('Following', USER_PROFILE_TEXTDOMAIN),
	...
	function user_profile_filter_profile_navs_about($user_id){
		...
		<div class="basic-info">
        	<div class="container">
                ...
                <h5 class=""><?php echo __('Basic Info', USER_PROFILE_TEXTDOMAIN); ?></h5>
                ...
                <div class="item gender">
                    <span class=""><?php echo __('Gender:', USER_PROFILE_TEXTDOMAIN); ?> </span><span class=""><?php echo $gender_title; ?></span>
                </div> 
                <?php
                endif;
				?>
                ...
                <div class="item relationship">
               	 <span class=""><?php echo __('Relationship:', USER_PROFILE_TEXTDOMAIN); ?> </span><span class=""><?php echo $relationship_title; ?></span>
                </div>            
                ...
                <div class="item religious">
                	<span class=""><?php echo __('Religious:', USER_PROFILE_TEXTDOMAIN); ?> </span><span class=""><?php echo $religious; ?></span>
                </div>            
                
                <div class="item birth_date">
                	<span class=""><?php echo __('Birth date:', USER_PROFILE_TEXTDOMAIN); ?> </span><span class=""><?php echo $birth_date; ?></span>
                </div>
                
                <div class="item website">
                	<span class=""><?php echo __('Website:', USER_PROFILE_TEXTDOMAIN); ?> </span><span class=""><a href="<?php echo $website; ?>"><?php echo $website; ?></a></span>
                </div>            
            ...
            <div class="container">
               ...
               <h5 class=""><?php echo __('Contacts', USER_PROFILE_TEXTDOMAIN); ?></h5> 
        ...
        <div class="other-info">
        	<div class="container">
            	...
            	<div class="info-box">
                <h4><?php echo __('Education', USER_PROFILE_TEXTDOMAIN); ?></h4>
				...
				foreach($user_profile_education as $index=>$education){
					...
					?>
                    <span class="date"> <?php echo __('Running.', USER_PROFILE_TEXTDOMAIN); ?></span>
                    <?php
            	...
            	<div class="info-box">
                <h4><?php echo __('Work', USER_PROFILE_TEXTDOMAIN); ?></h4>
            	...
            	<div class="info-box">
                <h4><?php echo __('Places', USER_PROFILE_TEXTDOMAIN); ?></h4>
				...
				foreach($user_profile_places as $index=>$place){
					...
					?><div class="item">
                    <span class="icon user_profile-tooltip" title="<?php echo __('Click to delete.', USER_PROFILE_TEXTDOMAIN); ?>"><i class="fa fa-map-pin" aria-hidden="true"></i></span>
	...
	function user_profile_filter_profile_navs_following($user_id){
        ...
        <?php echo sprintf(__('Total following: %s', USER_PROFILE_TEXTDOMAIN), $total_following); ?>
        </div>
        <?php
        ...
        foreach($follower_query as $entry){
			...
			if($already_insert > 0 ){
				...
				$follow_text = __('Following', USER_PROFILE_TEXTDOMAIN);
	...
	function user_profile_filter_profile_navs_follower($user_id){
        ...
        <?php echo sprintf(__('Total follower: %s', USER_PROFILE_TEXTDOMAIN), $total_follower); ?>
        </div>
        <?php
		...
		echo __('No follower found', USER_PROFILE_TEXTDOMAIN);
		endif;
	...
	public function user_gender() {
		...
		$gender['male'] = array(
									'title'=>__('Male', USER_PROFILE_TEXTDOMAIN),
		...
		$gender['female'] = array(
									'title'=>__('Female', USER_PROFILE_TEXTDOMAIN),
									'icon'=>'<i class="fa fa-female" aria-hidden="true"></i>',
									);									
									
		$gender['others'] = array(
									'title'=>__('Others', USER_PROFILE_TEXTDOMAIN),
									'icon'=>'<i class="fa fa-google-plus-official" aria-hidden="true"></i>',
	...
	public function user_relationship() {
		...
		$relations['single'] = array(
									'title'=>__('Single', USER_PROFILE_TEXTDOMAIN),
									'icon'=>'<i class="fa fa-facebook"></i>',
									);
									
		$relations['engaged'] = array(
									'title'=>__('Engaged', USER_PROFILE_TEXTDOMAIN),
									'icon'=>'<i class="fa fa-facebook"></i>',
									);
									
		$relations['in_relationship'] = array(
									'title'=>__('In a relationship', USER_PROFILE_TEXTDOMAIN),
									'icon'=>'<i class="fa fa-facebook"></i>',
									);
								
		$relations['married'] = array(
									'title'=>__('Married', USER_PROFILE_TEXTDOMAIN),
									'icon'=>'<i class="fa fa-facebook"></i>',
									);								
								
		$relations['separated'] = array(
									'title'=>__('Separated', USER_PROFILE_TEXTDOMAIN),
									'icon'=>'<i class="fa fa-facebook"></i>',
									);								
								
		$relations['divorced'] = array(
									'title'=>__('Divorced', USER_PROFILE_TEXTDOMAIN),
									'icon'=>'<i class="fa fa-facebook"></i>',
									);								
		$relations['widowed'] = array(
									'title'=>__('Widowed', USER_PROFILE_TEXTDOMAIN),
									'icon'=>'<i class="fa fa-facebook"></i>',
									);									
	...
	public function get_pages_list() {
		$array_pages[''] = __('None', USER_PROFILE_TEXTDOMAIN);
