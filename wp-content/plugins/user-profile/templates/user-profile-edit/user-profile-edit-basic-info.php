...
<div class="section basic-info">
	<h2><?php echo __('Basic Info', USER_PROFILE_TEXTDOMAIN); ?></h2>
        <div class="status">
        <?php echo $status_html; ?>
   		...
   		<form id="user-profile-basic-info" class="" action="#user-profile-basic-info" method="post">
			...
			<p>
            <label>
            <?php echo __('Birth date', USER_PROFILE_TEXTDOMAIN); ?>
            </label>
			...
			<p>
            <label>
            <?php echo __('Relationsship', USER_PROFILE_TEXTDOMAIN); ?>
            </label>
			...
			<p>
            <label>
            <?php echo __('Gender', USER_PROFILE_TEXTDOMAIN); ?>
            </label>
			...
			<p>
            <label>
             <?php echo __('Religious', USER_PROFILE_TEXTDOMAIN); ?>
            </label>
			...
			<p>
            <label>
             <?php echo __('Website', USER_PROFILE_TEXTDOMAIN); ?>
            </label>
