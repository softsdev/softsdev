...
<div class="section contacts">
   <h2><?php echo __('Contacts', USER_PROFILE_TEXTDOMAIN); ?></h2>
	...
	<?php echo $status_html; ?>
   		...
   		<div class="add-contacts button"><?php echo __('Add', USER_PROFILE_TEXTDOMAIN); ?></div>
       ...
       <?php
		...
		foreach($user_profile_contacts as $index=>$work){
            ...
            <div class="item">
                ...
                <input placeholder="<?php echo __('Location', USER_PROFILE_TEXTDOMAIN); ?>" type="text" name="user_profile_contacts[<?php echo $index; ?>][username]" value="<?php echo $username; ?>" />
                <input placeholder="<?php echo __('Address', USER_PROFILE_TEXTDOMAIN); ?>" type="text" name="user_profile_contacts[<?php echo $index; ?>][profile_link]" value="<?php echo $profile_link; ?>" />
