...
<div class="section places">
   <h2><?php echo __('Places', USER_PROFILE_TEXTDOMAIN); ?></h2>
	...
	<?php echo $status_html; ?>
   		...
   		<div class="add-places button"><?php echo __('Add', USER_PROFILE_TEXTDOMAIN); ?></div>
       ...
       <?php
		...
		foreach($user_profile_places as $index=>$work){
            ...
            <div class="item">
                ...
                <input placeholder="<?php echo __('Location', USER_PROFILE_TEXTDOMAIN); ?>" type="text" name="user_profile_places[<?php echo $index; ?>][location]" value="<?php echo $location; ?>" />
                <input placeholder="<?php echo __('Address', USER_PROFILE_TEXTDOMAIN); ?>" type="text" name="user_profile_places[<?php echo $index; ?>][address]" value="<?php echo $address; ?>" />
