...
<div class="section work">
   <h2><?php echo __('Work', USER_PROFILE_TEXTDOMAIN); ?></h2>
	...
	<?php echo $status_html; ?>
   		...
   		<div class="add-work button"><?php echo __('Add', USER_PROFILE_TEXTDOMAIN); ?></div>
		...
		foreach($user_profile_work as $index=>$work){
            ...
            <div class="item">
                ...
                <input placeholder="<?php echo __('Position', USER_PROFILE_TEXTDOMAIN); ?>" type="text" name="user_profile_work[<?php echo $index; ?>][position]" value="<?php echo $position; ?>" />
                <input placeholder="<?php echo __('Company', USER_PROFILE_TEXTDOMAIN); ?>" type="text" name="user_profile_work[<?php echo $index; ?>][company]" value="<?php echo $company; ?>" />
                <input size="8" class="user_profile_date" placeholder="<?php echo __('Start date', USER_PROFILE_TEXTDOMAIN); ?>" type="text" name="user_profile_work[<?php echo $index; ?>][start_date]" value="<?php echo $start_date; ?>" />
                <input size="8" class="user_profile_date" placeholder="<?php echo __('End date', USER_PROFILE_TEXTDOMAIN); ?>" type="text" name="user_profile_work[<?php echo $index; ?>][end_date]" value="<?php echo $end_date; ?>" />
                <label><input title="" name="user_profile_work[<?php echo $index; ?>][running]" <?php if(!empty($running)) echo 'checked'; ?>  type="checkbox" value="yes" /> <?php echo __('Running', USER_PROFILE_TEXTDOMAIN); ?></label>
            </div>
