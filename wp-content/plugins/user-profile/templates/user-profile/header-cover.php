...
?>
	...
	<div class="cover">
        ...
        <?php
            ...
            echo '<div id="plupload-drag-drop'.$field_id.'" ><span id="plupload-browse-'.$field_id.'" class="clipart-upload button tooltip" title="'.__('Upload profile cover image.', USER_PROFILE_TEXTDOMAIN).'"><i class="fa fa-upload"></i></span></div>';
          ...
          $plupload_init = array(
           ...
           // 'container'           => 'plupload-'.$field_id.'',
            ...
            'filters'             => array(array('title' => __('Allowed Files', USER_PROFILE_TEXTDOMAIN), 'extensions' => 'gif,png,jpg,jpeg')),
            'multipart'           => true,
                 ...
                 <script>
                    ...
                    jQuery(document).ready(function($){
                      ...
                      uploader_'.$field_id.'.bind("FilesAdded", function(up, files){
						...
						$(".toast").html("'.__('Please wait.', USER_PROFILE_TEXTDOMAIN).'");
