...
?>
    ...
    <div class="thumb">
        ...
        <?php
            ...
            echo '<div id="plupload-drag-drop'.$field_id.'" ><span id="plupload-browse-'.$field_id.'" class="clipart-upload button tooltip" title="'.__('Upload profile image.', USER_PROFILE_TEXTDOMAIN).'"><i class="fa fa-upload"></i></span></div>';
