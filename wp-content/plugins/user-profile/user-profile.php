...
class UserProfile{
	...
	public function load_textdomain() {
		...
		load_plugin_textdomain( USER_PROFILE_TEXTDOMAIN, false, plugin_basename( dirname( __FILE__ ) ) . '/languages/' ); 
	}
	...
	public function user_profile_define_constants() {
		...
		$this->define('USER_PROFILE_TEXTDOMAIN', 'user-profile' );
		$this->define('USER_PROFILE_PLUGIN_NAME', __('User Profile', USER_PROFILE_TEXTDOMAIN) );
