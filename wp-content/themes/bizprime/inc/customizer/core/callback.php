...
if ( ! function_exists( 'bizprime_is_select_page_slider' ) ) :
	 ...
	 */
	function bizprime_is_select_page_slider( $control ) {
...
if ( ! function_exists( 'bizprime_is_select_cat_slider' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function bizprime_is_select_cat_slider( $control ) {
