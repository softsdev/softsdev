...
if ( ! function_exists( 'mediclean_import_custom_css' ) ) :
	 ...
	 * @since 1.1.7
	 */
	function mediclean_import_custom_css() {
...
add_action( 'after_setup_theme', 'mediclean_import_custom_css', 99 );
