    ...
    */
    private function widget_fields() {
        ...
        $fields = array(            
            'banner_start_group_left' => array(
                ...
                'bizintro_widgets_title' => esc_html__('Carousel Slider Banner Section', 'spidermag'),
                'bizintro_widgets_field_type' => 'group_start',
            ),
            'banner_carousel_block_category' => array(
              'bizintro_widgets_name' => 'banner_carousel_block_category',
              'bizintro_mulicheckbox_title' => esc_html__('Select Category', 'spidermag'),
            ...
            'banner_carousel_block_number_post' => array(
                'bizintro_widgets_name' => 'banner_carousel_block_number_post',
            ...
            'banner_carousel_block_post_order' => array(
                'bizintro_widgets_name' => 'banner_carousel_block_post_order',
                'bizintro_widgets_title' => esc_html__('Display Posts Orderby', 'spidermag'),
                'bizintro_widgets_field_type' => 'select',
                'bizintro_widgets_field_options' => array('desc' => 'Descending Order', 'asc' => 'Accessing Order')
            ),
            'banner_carousel_category_show' => array(
                'bizintro_widgets_name' => 'banner_carousel_category_show',
    ...
    public function widget($args, $instance) {
        ...
        if(!empty($banner_carousel_block_category)){
            $multi_left_cat_id = array_keys($banner_carousel_block_category);
        }
