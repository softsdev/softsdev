...
class spidermag_slider_block extends WP_Widget {
    ...
    */
    private function widget_fields() {
        ...
        $fields = array(    
            ...
            'carousel_block_category' => array(
              'bizintro_widgets_name' => 'carousel_block_category',
            ...
            'carousel_block_number_post' => array(
                'bizintro_widgets_name' => 'carousel_block_number_post',
            ...
            'carousel_block_post_order' => array(
                'bizintro_widgets_name' => 'carousel_block_post_order',
            ...
            'banner_block_category_show' => array(
                'bizintro_widgets_name' => 'banner_block_category_show',
    ...
    public function widget($args, $instance) {
        ...
        $carousel_category           = empty( $instance['carousel_block_category'] ) ? 0 : $instance['carousel_block_category'];
        ...
        if(!empty($carousel_category)){
            $multi_left_cat_id = array_keys( $carousel_category );
        }
    ...
    echo $before_widget; ?>
        ...
        <div class="col-sm-16 col-md-8 col-lg-8">
            ...
            <div id="sync1" class="owl-carousel spider_slider">
                    ...
                    <?php if( $get_featured_posts->have_posts() ) { while( $get_featured_posts->have_posts() ){ $get_featured_posts->the_post(); ?>
                        <div class="item">
                            <?php 
                                ...
                                $image = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'spidermag-banner-slider-thumb', true);
                            ?>
                                <img class="img-responsive" src="<?php echo esc_url( $image[0] ); ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
                            <?php } ?>
                        </div>
