    ...
    */
    private function widget_fields() {        
        ...
        $fields = array( 
            ...
            'five_block_number_post' => array(
                'bizintro_widgets_name' => 'five_block_number_post',
            ...
            'five_block_post_order' => array(
                'bizintro_widgets_name' => 'five_block_post_order',
            ...
            'five_block_category_show' => array(
                'bizintro_widgets_name' => 'five_block_category_show',
    ...
    public function widget($args, $instance) {
        ...
        if(!empty($five_block_list_category)){
            $multi_left_cat_id = array_keys($five_block_list_category);
        }
                ...
                <div class="col-md-16 col-sm-16">
                    <div class="row">
                        <?php 
                            ...
                            if ($i == 1) {
                        ?>
                        <div class="col-md-8 col-sm-8 col-xs-16 wow fadeInLeft animated science animated">
                            <div class="topic">
                        ...
                        <?php } else{ 
                             if ( $i==2 ) 
                                echo '<div class="col-md-8 col-sm-8 col-xs-16 wow fadeInRight animated animated"><ul class="list-unstyled">'; ?>
                                    <li>                                        
                                        <div class="row">
