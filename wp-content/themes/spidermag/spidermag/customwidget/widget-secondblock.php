    ...
    private function widget_fields() {
        ...
        $fields = array(  
            ...
            'second_block_number_post_left' => array(
                'bizintro_widgets_name' => 'second_block_number_post_left',
            ...
            'second_block_post_order_left' => array(
                'bizintro_widgets_name' => 'second_block_post_order_left',
                'bizintro_widgets_title' => esc_html__('Display Posts Order', 'spidermag'),
                'bizintro_widgets_field_type' => 'select',
                'bizintro_widgets_field_options' => array('desc' => 'Deaccessing Order', 'asc' => 'Accessing Order')
            ),
            ...
            'banner_start_group_right' => array(
                ...
                'bizintro_widgets_title' => esc_html__('Right Block Section', 'spidermag'),
                'bizintro_widgets_field_type' => 'group_start',
            ),

            'second_block_title_right' => array(
                'bizintro_widgets_name' => 'second_block_title_right',
                'bizintro_widgets_title' => esc_html__('Title', 'spidermag'),
                'bizintro_widgets_field_type' => 'title',
            ),

            'second_block_category_right' => array(
              'bizintro_widgets_name' => 'second_block_category_right',
              'bizintro_mulicheckbox_title' => esc_html__('Select Block Category', 'spidermag'),
              'bizintro_widgets_field_type' => 'multicheckboxes',
              'bizintro_widgets_field_options' => $mag_categories_lists
            ),
            ...
            'second_block_number_post_right' => array(
                'bizintro_widgets_name' => 'second_block_number_post_right',
                'bizintro_widgets_title' => esc_html__('Display Number of Posts', 'spidermag'),
                'bizintro_widgets_field_type' => 'number',
            ),

            'second_block_post_order_right' => array(
                'bizintro_widgets_name' => 'second_block_post_order_right',
                'bizintro_widgets_title' => esc_html__('Display Posts Order', 'spidermag'),
                'bizintro_widgets_field_type' => 'select',
                'bizintro_widgets_field_options' => array('desc' => 'Deaccessing Order', 'asc' => 'Accessing Order' )
            ), 
            ...
            'second_block_category_show' => array(
                'bizintro_widgets_name' => 'second_block_category_show',
    ...
    */
    public function widget($args, $instance) {
        ...
        if(!empty($second_block_category_left)){
            $multi_left_cat_id = array_keys($second_block_category_left);
        }
        ...
        if(!empty($second_block_category_right)){
            $multi_right_cat_id = array_keys($second_block_category_right);
        }
        // right section
