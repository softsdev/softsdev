    ...
    */
    private function widget_fields() {        
        ...
        $fields = array(   
            ...
            'six_block_number_post' => array(
                'bizintro_widgets_name' => 'six_block_number_post',
            ...
            'six_block_post_order' => array(
                'bizintro_widgets_name' => 'six_block_post_order',
            ...
            'six_block_alternative_show' => array(
                'bizintro_widgets_name' => 'six_block_alternative_show',
                'bizintro_widgets_title' => esc_html__('Check to Display Alternative Post', 'spidermag'),
    ...
    public function widget($args, $instance) {
        ...
        if(!empty($six_block_list_category)){
            $multi_left_cat_id = array_keys($six_block_list_category);
        }
