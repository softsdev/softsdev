    ...
    private function widget_fields() {
        $fields = array(  
            ...
            'latest_tabbed_post_recent' => array(
                'bizintro_widgets_name' => 'latest_tabbed_post_recent',
                'bizintro_widgets_field_type' => 'checkbox',
                'bizintro_widgets_title' => esc_html__('Show Recent Posts', 'spidermag'),
            ),

            'latest_tabbed_post_random' => array(
                'bizintro_widgets_name' => 'latest_tabbed_post_random',
                'bizintro_widgets_field_type' => 'checkbox',
                'bizintro_widgets_title' => esc_html__('Show Random Posts', 'spidermag'),
            ),

            'latest_tabbed_post_comments' => array(
                'bizintro_widgets_name' => 'latest_tabbed_post_comments',
                'bizintro_widgets_field_type' => 'checkbox',
                'bizintro_widgets_title' => esc_html__('Show Comments', 'spidermag'),
            ),

            'latest_tabbed_number_post' => array(
                'bizintro_widgets_name' => 'latest_tabbed_number_post',
                    ...
                    <li>
                      <div class="row">
                        ...
                        <div class="col-sm-11  col-md-12 ">
                          <h4><?php echo esc_attr( $comment->comment_author ); ?></h4>
