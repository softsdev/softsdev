 ...
 * Load External Plugins Recommend Activation file
*/
require spidermag_file_directory( '/spidermag/spidermag-plugin-activation.php' );

/**
 * Load theme about page
*/
require spidermag_file_directory('spidermag/admin/about-theme/spidermag-about.php');